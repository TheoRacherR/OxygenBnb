...
describe('AuthController', () => {
  ...
  describe('register', () => {
    it(`should return User created`, () => {
      expect(controller.register(authRegisterMock)).resolves.toEqual({
        message: `User created`,
      });
    });

    it(`should return an error : { Email already exist }`, () => {
      expect(controller.register(authRegisterEmailFoundMock)).rejects.toThrow(
