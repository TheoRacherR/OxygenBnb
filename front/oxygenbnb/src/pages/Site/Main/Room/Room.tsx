          ...
          <div className={styles.right}>
            ...
            <div className={styles.dates} id='dates'>
              <div className={styles.dtop}>
                ...
                <div className={styles.dright} onClick={e => setAnchor({date_start: null, date_end: e.currentTarget, people: null})}>
              ...
              <div className={styles.dbottom}>
                ...
                >
                  ...
                  <Button onClick={() => setNumberOfPeopleSelected(prev => ({...prev, adult: prev.adult-1}))} disabled={numberOfPeopleSelected.adult <= 0}><RemoveRoundedIcon sx={{color: "#C96217"}}/></Button>
            ...
            <div className={styles.submit_button}>
              <Button variant='contained' color="error" sx={{width: "100%", margin: "20px 0"}}>Reserve</Button>
            </div>
