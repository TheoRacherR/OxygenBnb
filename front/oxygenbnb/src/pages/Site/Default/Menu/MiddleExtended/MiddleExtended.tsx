  ...
  return (
    <div className={styles.middle}>
      ...
      <div className={styles.when_start}>
        ...
        {t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start.from")} : {nightSelected.start.length === 0 ? "" : dayjs(nightSelected.start).format(t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start.format"))} 
          / {t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start.to")} : {nightSelected.end.length === 0 ? "" : dayjs(nightSelected.end).format(t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start.format"))}
        </Button>
      </div>
      <Menu
        id="basic-menu"
      ...
      >
        <MenuItem>
          <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale={t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start_menu.lang")}>
            <DatePicker
              value={nightSelected.start === "" ? null : dayjs(nightSelected.start)}
              format={t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start_menu.format")}
              sx={{width: '100%'}}
              label={t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start_menu.start_input.label")}
            ...
            nightSelected.start ?
              <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale={t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start_menu.lang")}>
                <DatePicker
                  ...
                  format={t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start_menu.format")}
                  sx={{width: '100%'}}
                  label={t("site_default:default.menu.middle_extended.middle_extended_tsx.when_start_menu.end_input.label")}
      ...
      <div className={styles.who}>
        <Button onClick={handleOpenWho}>
          {t("site_default:default.menu.middle_extended.middle_extended_tsx.who.title")} : {numberOfPeopleSelected.adult} {t("site_default:default.menu.middle_extended.middle_extended_tsx.who.people1")}{numberOfPeopleSelected.adult > 1 ? "s" : ""} {/*<EscalatorWarningRoundedIcon sx={{margin: "0 3px"}}/> {numberOfPeopleSelected.children} */}
        </Button>
      </div>
      <Menu
        id="basic-menu"
      ...
      >
        <MenuItem>
          {`${t("site_default:default.menu.middle_extended.middle_extended_tsx.who_menu.title1")}: `}
        </MenuItem>
